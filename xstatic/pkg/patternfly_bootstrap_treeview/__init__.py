...
DISPLAY_NAME = 'Patternfly-Bootstrap-Treeview' # official name, upper/lowercase allowed, no spaces
...
MAINTAINER = 'David Moreau Simard'
MAINTAINER_EMAIL = 'dmsimard@redhat.com'
